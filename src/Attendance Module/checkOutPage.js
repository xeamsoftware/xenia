...
import {
    AsyncStorage, Alert, PermissionsAndroid, Image, StyleSheet, Text,
        ...
        submit = async (latitude, longitude) => {
            ...
            xhr.addEventListener("readystatechange", function () {
                ...
                if (xhr.status === 200) {
                    ...
                    context.setState({comment: 'Check-Out'})
                    ...
                    Alert.alert(userName.toUpperCase(),"YOUR ATTENDANCE HAS BEEN SUCCESSFULLY SAVED", [{
