...
import {View, Text, TextInput, Animated, StyleSheet, ScrollView, FlatList, TouchableOpacity} from 'react-native';
...
class SearchableDropDown extends Component{
    ...
    render(){
        ...
        const {
            ...
            dropDownBG = ['#E6E6E6', 'white'], dropDownTextStyle = null, slidePlaceHolderVertical=[0, getMarginTop(-3.5).marginTop],
            slidePlaceHolderHorizontal=[0, getMarginTop(-1.5).marginTop], containerStyle = null, dropDownPosition = null
        } = this.props;
            ...
            transform: [
                {
                    translateX: animatePlaceHolder.interpolate({
                        inputRange: [0, 1],
                        outputRange: slidePlaceHolderHorizontal
                    })
                },
                {
                    translateY: animatePlaceHolder.interpolate({
                        inputRange: [0, 1],
                        outputRange: slidePlaceHolderVertical
                    })
                },
                {
                        ...
                        <TouchableOpacity style={[]} activeOpacity={0.7} onPress={() => {
                            ...
                            <Animated.View style={[style, {justifyContent: 'center'}]}>
                                ...
                                <View pointerEvents="none" style={[{position: 'absolute'}]}>
                                    <Animated.Text style={[{backgroundColor: '#FFF'}, getMarginLeft(1.5), placeholderAnimation]}> {placeholder} </Animated.Text>
                                </View>
                            </Animated.View>
                        </TouchableOpacity>
                    )}
